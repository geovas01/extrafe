...
type
  TRowZinc_Game = class(TGpXMLData)
    private
      function GetRunGameNummber : Integer;
      procedure SetRunGameNumber(const Value: Integer);
    ...
    public
      ...
      property RunGameNumber : Integer read GetRunGameNummber write SetRunGameNumber;
