...
//==============================================================================
  ...
  protected
    ...
    Function DeletePItem(aVariable: Pointer): boolean;
  public
    ...
    Procedure FreeByItem(const aItem: TBaseTweenItem);
    Procedure FreeAll;
    ...
    Function DeletePSingle(aVariable: PSingle): boolean;
    Function DeletePVector(aVariable: PVector): boolean;
...
//------------------------------------------------------------------------------
Function TTweener.DeletePItem(aVariable: Pointer): boolean;
var
  i: integer;
  item: TBaseTweenItem;
begin
  ...
  begin
    ...
    if(item is TPSingleTweenItem)and(TPSingleTweenItem(item).fValue = aVariable)
    or(item is TPVectorTweenItem)and(TPVectorTweenItem(item).fValue = aVariable)then
    begin
      result := true;
      FreeByItem(item);
    end
...
//------------------------------------------------------------------------------
Procedure TTweener.FreeByItem(const aItem: TBaseTweenItem);
var
  aIndex: Integer;
begin
  aIndex := fTweenItems.IndexOf(aItem);
  if aIndex <> -1 then
    FreeByIndex(aIndex);
end;
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
Function TTweener.DeletePSingle(aVariable: PSingle): boolean;
begin
  result := DeletePItem(aVariable);
end;
//------------------------------------------------------------------------------
Function TTweener.DeletePVector(aVariable: PVector): boolean;
begin
  result := DeletePItem(aVariable);
end;
//------------------------------------------------------------------------------
